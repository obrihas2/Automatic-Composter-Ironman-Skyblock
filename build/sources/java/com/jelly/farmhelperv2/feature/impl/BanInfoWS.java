...
public class BanInfoWS implements IFeature {
    ...
    public BanInfoWS() {
        try {
            if (!FarmHelperConfig.sendAnalyticData) {
                // Analytics disabled: do not initialize websocket
                client = null;
                return;
            }
    ...
    public void onCheckIfDisconnected(TickEvent.ClientTickEvent event) {
        if (!FarmHelperConfig.sendAnalyticData) return;
    ...
    private JsonObject getHeaders() {
        ...
        try {
            ...
            // e.printStackTrace(); // Commented out to prevent spam
    ...
    private WebSocketClient createNewWebSocketClient() throws URISyntaxException {
        return new WebSocketClient(new URI("ws://ws.may2bee.pl")) {
            ...
            public void onError(Exception ex) {
                ...
                // ex.printStackTrace(); // Commented out to prevent spam
            }
        };
    }
